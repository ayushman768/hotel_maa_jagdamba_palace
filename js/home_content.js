(function() {
    ...
    document.querySelector('article').innerHTML += '<div class="container"><div class="row"><h1 class="text-center">Welcome To  Maa Jagdamba  Palace</h1></div></div>';
...
var my_Content = function() {
    ...
    var myContent = [{
        ...
        image02: 'images/jagdamba_palace+in_bilaspur_reception (1).jpg',
        ...
        document.querySelector('.article04>.container>.row').innerHTML += `
		  <div class="col-md-4">
		       <div class="${jason06[i].class} text-center">
			      <div class="blur">
			         <p class="color_white">${jason06[i].name}</p>
				   </div>
			   </div>
		  </div>
		`;
